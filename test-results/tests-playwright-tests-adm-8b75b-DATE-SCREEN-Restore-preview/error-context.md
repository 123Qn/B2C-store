...
- Name: tests\playwright\tests\admin\update-screen.spec.ts >> ADMIN UPDATE SCREEN >> Restore preview
- Location: tests\playwright\tests\admin\update-screen.spec.ts:220:3
