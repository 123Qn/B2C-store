...
- Name: tests\playwright\tests\web\search-screen.spec.ts >> SEARCH SCREEN >> Search finds multiple posts
- Location: tests\playwright\tests\web\search-screen.spec.ts:26:3
...
Call log:
  - navigating to "/search?q=front", waiting until "load"
