...
- Name: tests\playwright\tests\web\category-screen.spec.ts >> CATEGORY SCREEN >> Invalid Category
- Location: tests\playwright\tests\web\category-screen.spec.ts:34:3
...
Call log:
  - navigating to "/category/abc", waiting until "load"
