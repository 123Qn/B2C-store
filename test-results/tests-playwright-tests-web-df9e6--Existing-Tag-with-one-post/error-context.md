...
- Name: tests\playwright\tests\web\tags-screen.spec.ts >> TAG SCREEN >> Existing Tag with one post
- Location: tests\playwright\tests\web\tags-screen.spec.ts:4:3
...
Call log:
  - navigating to "/tags/dev-tools", waiting until "load"
