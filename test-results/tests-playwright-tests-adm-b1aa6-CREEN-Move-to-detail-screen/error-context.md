...
- Name: tests\playwright\tests\admin\list-screen.spec.ts >> ADMIN LIST SCREEN >> Move to detail screen
- Location: tests\playwright\tests\admin\list-screen.spec.ts:210:7
