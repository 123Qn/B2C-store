...
- Name: tests\playwright\tests\web\history-screen.spec.ts >> HISTORY SCREEN >> Invalid History
- Location: tests\playwright\tests\web\history-screen.spec.ts:24:3
...
Call log:
  - navigating to "/history/2024/1", waiting until "load"
