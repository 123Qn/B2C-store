...
- Name: tests\playwright\tests\web\search-screen.spec.ts >> SEARCH SCREEN >> Invalid Search
- Location: tests\playwright\tests\web\search-screen.spec.ts:51:3
...
Call log:
  - navigating to "/search?q=abc", waiting until "load"
