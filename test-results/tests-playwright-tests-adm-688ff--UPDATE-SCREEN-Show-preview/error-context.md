...
- Name: tests\playwright\tests\admin\update-screen.spec.ts >> ADMIN UPDATE SCREEN >> Show preview
- Location: tests\playwright\tests\admin\update-screen.spec.ts:201:3
