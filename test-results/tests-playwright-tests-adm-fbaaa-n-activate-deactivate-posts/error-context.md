...
- Name: tests\playwright\tests\admin\list-screen.spec.ts >> ADMIN LIST SCREEN >> Can activate / deactivate posts
- Location: tests\playwright\tests\admin\list-screen.spec.ts:253:3
