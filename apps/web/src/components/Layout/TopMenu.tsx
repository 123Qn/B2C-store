...
export function TopMenu() {
  ...
  return (
    ...
    <>
      ...
      {/* NAVBAR */}
      <div className="flex items-center justify-between bg-[#758A93] px-8 py-5">
        ...
        <div className="relative w-[450px]">
          ...
          <input
            ...
            className="w-full rounded-full bg-white px-5 py-3 pl-12 text-black shadow-lg outline-none focus:ring-2 focus:ring-gray-400"
          />
