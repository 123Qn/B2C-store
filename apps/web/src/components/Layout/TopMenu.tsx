...
import logo
from "../../../public/wsulogo.png";

import heroImage
from "../../asset/image/hero.webp";

import { useCart }
from "../Cart/CartContext";

import { SearchPopup }
from "../Search/SearchPopup";

import { handleLogout }
from "@/app/utils/logout";
...
export function TopMenu() {
  ...
  return (
    ...
    <>
      ...
      {/* NAVBAR */}
      <div className="bg-[#D8C6C0] px-4 md:px-8 py-5">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          ...
          >
            ...
            <span className="text-2xl md:text-4xl text-[#F7F2EF] font-semibold">
              Q Fashion
            </span>
          ...
          <div className="flex items-center gap-3 md:gap-5">
            ...
            {loggedIn ? (
              ...
              <button
                ...
                className="bg-[#8B6B61] text-white px-3 md:px-4 py-2 rounded-full hover:bg-gray-800 transition"
              >
                Logout
              </button>
              ...
              <Link
                ...
                className="bg-white text-black px-3 md:px-4 py-2 rounded-full hover:bg-gray-200 transition"
              >
                Login
              </Link>
            ...
            <Link
              ...
              title="Order History"
              className="text-white text-2xl md:text-3xl hover:text-gray-300 transition"
            >
              📦
            </Link>
            ...
            <Link
              ...
              title="Cart"
              className="relative text-white text-2xl md:text-3xl hover:text-gray-300 transition"
            >
        ...
        {/* SEARCH */}
        <div className="relative mt-5 w-full lg:max-w-[500px] lg:mx-auto">
