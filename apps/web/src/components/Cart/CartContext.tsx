...
import { addItemToCart, removeItemFromCart, increaseItemQuantity, decreaseItemQuantity } from "./cartAction";
...
export function CartProvider({ children, }: { children: React.ReactNode; }) {
  ...
  // REMOVE
  function removeFromCart(id: number, selectedSize: string) {
