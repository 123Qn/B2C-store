...
export default function CartPage() {
  ...
  // SIMPLE TOKEN CHECK - TopMenu handles full auth verification
  useEffect(() => {
    ...
    <div className="min-h-screen bg-[#FFF8F3]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="mb-8 lg:mb-10">
          <Link href="/" className="inline-flex items-center text-sm sm:text-base text-gray-600 hover:text-black transition">
            ← Continue Shopping
          </Link>
